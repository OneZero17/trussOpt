function runHybridOptimizationCaseWithPenalty(x, y, continuumSpacing, discreteSpacing, filterLevel, InputLoads, InputSupports, caseNo, radius, jointLength)
    ...
    continuumProblem.updateDensityCoefficientWithGivenValue(densityList);
