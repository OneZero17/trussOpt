...
support1NodeIndex = groundStructure.findOrAppendNode(x, 0);
support2NodeIndex = groundStructure.findOrAppendNode(0, 0);
...
for i = 1:size(splitedFloors, 2) - 1
    ...
    plot([0, x], [splitedFloors(i), splitedFloors(i)], 'Color', 'black');
    plot([0, x], [splitedFloors(i+1), splitedFloors(i+1)], 'Color', 'black');
    axis equal
end
