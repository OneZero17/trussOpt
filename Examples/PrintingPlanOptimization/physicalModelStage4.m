...
[totalPieces, maximumOverhang] = slicing(membersInEachFloor, zGrids, anglesForEachFloor, maximumOverhangAngle, maximumB, splintLineX, splintLineY, floorLineZ, levelSpacing, printSpacing, toolPathSpacing, shrinkLength, false, false);
...
function [totalPieces, maximumOverhang] = slicing(membersInEachFloor, zGrids, anglesForEachFloor, maximumOverhangAngle, maximumB, splintLineX, splintLineY, floorLineZ, levelSpacing, printSpacing, toolPathSpacing, shrinkLength, addInfill, showToolPath)
    structureTools = OptStructureTools;
    ...
    for floorNum = 1:size(membersInEachFloor, 1)
        ...
        stlFileFolder = sprintf('stage4\\level%i\\', floorNum);
        if showToolPath
            figure(1)
            view([ 1 1 1]);
            axis equal
